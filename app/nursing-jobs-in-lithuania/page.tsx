...
import LithuaniaNursingLeadSection from "./LithuaniaNursingLeadSection";
import {
  advantages,
  articleSchema,
  arrivalSteps,
...
export default function NursingJobsInLithuaniaPage() {
  return (
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-16">
          <div>
            <div className="inline-flex rounded-full border border-blue-200 bg-white/90 px-4 py-2 text-sm font-medium text-blue-800 shadow-sm">
              2026-27 Lithuania nursing guide for Indian nurses
            </div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700 md:text-xl">
              Compare the LSMU study pathway, direct work route, salary, costs, visa steps and EU mobility upside before deciding whether Lithuania fits your nursing plan.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#lithuania-nursing-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading level="h2" eyebrow="Quick Summary" title="A fast Lithuania nursing snapshot before you go deeper" />
        ...
        <div className="mt-8 rounded-[28px] border border-amber-200 bg-amber-50 p-5 text-sm leading-7 text-amber-900">
          Lithuania is usually not the best salary-first destination. Its strongest value is affordability plus EU mobility after qualification or early-career experience.
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading eyebrow="Key Facts" title="At-a-glance Lithuania nursing facts for 2026-27" />
        <div className="mt-10"><DataTable rows={keyFacts} caption="Lithuania nursing key facts table" /></div>
      </section>

      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="What the Lithuania nursing route looks like for study and direct work" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Step By Step" title="The Lithuania process in the right order" />
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Eligibility" title="Who usually fits the Lithuania route best" />
          <div className="mt-10"><DataTable rows={eligibility} caption="Lithuania nursing eligibility table" /></div>
      ...
      <section id="institutions" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Top Institutions" title="The Lithuania hospitals and institutions Indian nurses should compare" />
        <div className="mt-10"><DataTable rows={institutions} caption="Lithuania nursing institutions table" /></div>
      </section>

      <section id="costs" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Costs and Fees" title="What the Lithuania pathway really costs" />
          <div className="mt-10"><DataTable rows={costBreakdown} caption="Lithuania nursing fees and costs table" /></div>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="#lithuania-nursing-contact-form" className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Get a Lithuania Plan</a>
            <a href={`tel:${ivrNumber.replace(/\s+/g, "")}`} className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Call IVR</a>
          </div>
        </div>
      </section>
      ...
      <section id="salary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Salary Data" title="What Lithuania nursing pay looks like in reality" />
        <div className="mt-10 grid gap-8 xl:grid-cols-2">
          <div>
            <h3 className="mb-4 text-xl font-bold text-slate-900">Salary by role</h3>
            <DataTable rows={salaryByRole} caption="Lithuania nursing salary by role table" />
          </div>
          <div>
            <h3 className="mb-4 text-xl font-bold text-slate-900">Salary compared with nearby EU options</h3>
            <DataTable rows={salaryComparison} caption="Lithuania nursing salary comparison table" />
          </div>
        </div>
        <p className="mt-8 rounded-3xl border border-amber-200 bg-amber-50 p-5 text-sm leading-7 text-amber-900">
          Lithuania works better as an EU qualification and mobility platform than as a pure savings destination. That is the key framing to keep in mind.
        </p>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Recognition" title="The systems that make Lithuania strategically useful" theme="dark" />
          <div className="mt-10"><DataTable rows={recognition} caption="Lithuania nursing recognition table" /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="LSMU Curriculum" title="What the 4-year English-medium LSMU nursing route looks like" />
        <div className="mt-10"><DataTable rows={curriculum} caption="LSMU nursing curriculum table" /></div>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="After Arrival" title="What happens after arrival or after graduation" />
          <div className="mt-10 grid gap-4 md:grid-cols-2">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Cost of Living" title="Why Lithuania's affordability matters to the overall strategy" />
        <div className="mt-10"><DataTable rows={livingCosts} caption="Lithuania nursing living cost table" /></div>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Pros and Cons" title="A realistic view of Lithuania for Indian nurses" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Comparison" title="How Lithuania compares with other nursing destinations" />
        <div className="mt-10"><DataTable rows={comparison} caption="Lithuania nursing comparison table" /></div>
        <p className="mt-6 text-base leading-7 text-slate-700">
If you want a stronger direct-earnings European route, compare this with <Link href="/nursing-job-in-germany" className="font-semibold text-blue-700 hover:text-blue-900">nursing jobs in Germany</Link>. If you want a stronger English-speaking salary-plus-PR route, compare it with <Link href="/nursing-jobs-in-canada" className="font-semibold text-blue-700 hover:text-blue-900">nursing jobs in Canada</Link>. For the broader education landscape, explore <Link href="/bsc-nursing" className="font-semibold text-blue-700 hover:text-blue-900">BSc Nursing abroad</Link> and <Link href="/mbbs-admission-in-germany-for-indian-students" className="font-semibold text-blue-700 hover:text-blue-900">MBBS in Germany for free</Link>.
        </p>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Support and Funding" title="Where practical support still exists in the Lithuania route" />
          <div className="mt-10"><DataTable rows={scholarships} caption="Lithuania nursing support options table" /></div>
        </div>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Documents" title="What to prepare for Lithuania study or work applications" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Career Pathways" title="What opens up after Lithuania qualification or licensing" />
        <div className="mt-10"><DataTable rows={careerPathways} caption="Lithuania nursing career pathways table" /></div>
      </section>
      ...
      <section className="bg-slate-50 py-12">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 lg:px-8">
          <div>
            ...
            <p className="mt-2 text-lg font-semibold text-slate-900">Talk to the Lithuania nursing team before you choose between study, direct work, and later EU mobility.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <a href="#lithuania-nursing-contact-form" className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Open Contact Form</a>
      ...
      <LithuaniaNursingLeadSection />

      <section id="faq" className="mx-auto max-w-5xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="FAQ" title="15 common Lithuania nursing questions Indian nurses ask" />
