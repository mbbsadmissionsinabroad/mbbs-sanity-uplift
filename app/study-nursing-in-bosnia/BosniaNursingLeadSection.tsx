...
function BosniaNursingLeadForm({
  formData,
  onChange,
  onSubmit,
  isLoading,
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        <label
          htmlFor="bosnia-nursing-name"
          className="mb-1 block text-sm font-medium text-slate-700"
        >
          Full name
        </label>
        <input
          id="bosnia-nursing-name"
          name="name"
          value={formData.name}
          onChange={onChange}
          required
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label
            htmlFor="bosnia-nursing-phone"
            className="mb-1 block text-sm font-medium text-slate-700"
          >
            WhatsApp number
          </label>
          <input
            id="bosnia-nursing-phone"
            name="phone"
        ...
        <div>
          <label
            htmlFor="bosnia-nursing-email"
            className="mb-1 block text-sm font-medium text-slate-700"
          >
            Email
          </label>
          <input
            id="bosnia-nursing-email"
            type="email"
            name="email"
      ...
      <div>
        <label
          htmlFor="bosnia-nursing-university"
          className="mb-1 block text-sm font-medium text-slate-700"
        >
          Preferred university
        </label>
        <select
          id="bosnia-nursing-university"
...
export default function BosniaNursingLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      ...
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: Study Nursing in Bosnia Page",
        },
      ],
    };
    ...
    try {
      ...
      await fetch("https://admission-backend.vercel.app/send-email", {
        method: "POST",
      ...
      router.push("/thank-you?title=Study%20Nursing%20in%20Bosnia");
    } catch (error) {
      console.error(error);
  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">
              Get personalised Bosnia nursing guidance
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Share your details and our team will help with eligibility,
              university fit, budget planning, visa steps and the Germany
      ...
      <section
        id="bosnia-nursing-contact-form"
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] bg-[linear-gradient(135deg,#1d4ed8_0%,#0f172a_100%)] p-8 text-white">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-blue-200">
              Contact Bosnia Nursing Desk
            </p>
            <h3 className="mt-4 text-3xl font-bold">
              Speak to our team on WhatsApp or request a callback
            </h3>
            <p className="mt-4 text-base leading-8 text-slate-300">
              Use this section for Bosnia nursing eligibility, university
              selection, visa planning, living-cost questions and Germany
              pathway guidance.
            </p>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <h3 className="mt-4 text-3xl font-bold text-slate-950">
              Request Bosnia nursing support
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Fill this once and the team can contact you with the Bosnia
              nursing route that best fits your budget, profile and Europe
              career goal.
            </p>
            <div className="mt-8">
              <BosniaNursingLeadForm
