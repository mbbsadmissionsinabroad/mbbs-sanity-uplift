...
function LeadForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        <label htmlFor="ksmu-name" className="mb-1 block text-sm font-medium text-slate-700">
          Full name
        </label>
        <input
          id="ksmu-name"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label htmlFor="ksmu-phone" className="mb-1 block text-sm font-medium text-slate-700">
            WhatsApp number
          </label>
          <input
            id="ksmu-phone"
        ...
        <div>
          <label htmlFor="ksmu-email" className="mb-1 block text-sm font-medium text-slate-700">
            Email
          </label>
          <input
            id="ksmu-email"
      ...
      <div>
        <label htmlFor="ksmu-program" className="mb-1 block text-sm font-medium text-slate-700">
...
export default function KrasnoyarskLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      fields: {
        ...
        Course: "MBBS Abroad",
        StudyCountry: "Russia",
        College: "Krasnoyarsk State Medical University",
        Notes: activeForm.preferredProgram,
      },
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: Krasnoyarsk State Medical University Page",
        },
      ],
    };
    ...
    try {
      ...
      router.push("/thank-you?title=Krasnoyarsk%20State%20Medical%20University");
    } catch (error) {
      console.error(error);
  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">
              Get personalised KSMU admission guidance
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Share your details and our team can help with KSMU fit, fee planning, visa steps, Russia living costs and India-return pathway decisions.
            </p>
      ...
      <section id="krasnoyarsk-contact-form" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              Fill this once and the team can contact you with KSMU-specific guidance on fees, hostel, climate, admission steps and the India-return pathway.
            </p>
            <div className="mt-8">
              <LeadForm
                formData={formData}
