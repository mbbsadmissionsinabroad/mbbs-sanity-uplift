...
function ItalyLeadForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        <label htmlFor="italy-name" className="mb-1 block text-sm font-medium text-slate-700">
          Full name
        </label>
        <input
          id="italy-name"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label htmlFor="italy-phone" className="mb-1 block text-sm font-medium text-slate-700">
            WhatsApp number
          </label>
          <input
            id="italy-phone"
        ...
        <div>
          <label htmlFor="italy-email" className="mb-1 block text-sm font-medium text-slate-700">
            Email
          </label>
          <input
            id="italy-email"
      ...
      <div>
        <label htmlFor="italy-university" className="mb-1 block text-sm font-medium text-slate-700">
...
export default function ItalyLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      ...
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: MBBS in Italy Page",
        },
      ],
    };
    ...
    try {
      ...
      router.push("/thank-you?title=MBBS%20in%20Italy");
    } catch (error) {
      console.error(error);
  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">
              Get personalised Italy admission guidance
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Share your details and our team will help with IMAT planning, shortlist fit, scholarship options, visa steps and the realistic Italy budget.
            </p>
      ...
      <section id="italy-contact-form" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] bg-[linear-gradient(135deg,#1d4ed8_0%,#0f172a_100%)] p-8 text-white">
            ...
            <p className="mt-4 text-base leading-8 text-slate-300">
              Use this section for IMAT strategy, public versus private university fit, DSU questions, visa support and 2026-27 Italy intake planning.
            </p>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              Fill this once and the team can contact you with Italy options that fit your goals, exam readiness and budget.
            </p>
            <div className="mt-8">
              <ItalyLeadForm
                formData={formData}
