...
import KyrgyzstanLeadSection from "./KyrgyzstanLeadSection";
import {
  additionalCosts,
  advantages,
  articleSchema,
    ...
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-sky-100">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
          <div>
            <div className="inline-flex rounded-full border border-sky-200 bg-white/90 px-4 py-2 text-sm font-medium text-sky-800 shadow-sm">2026-27 Kyrgyzstan admissions guide for Indian medical aspirants</div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700 md:text-xl">Compare Kyrgyzstan university fees, exam-risk differences, living costs, visa planning and India-return practicality before you choose a low-cost medical route.</p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#kyrgyzstan-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading level="h2" eyebrow="Quick Summary" title="A fast Kyrgyzstan snapshot before you go deeper" />
        ...
        <div className="mt-8 rounded-[28px] border border-sky-200 bg-sky-50 p-5 text-sm leading-7 text-sky-950">Kyrgyzstan is one of the easiest countries to enter on budget, but it rewards careful shortlisting far more than blind price-shopping.</div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading eyebrow="Key Facts" title="At-a-glance Kyrgyzstan medicine facts for 2026-27" />
        <div className="mt-10"><DataTable rows={keyFacts} caption="Kyrgyzstan medicine key facts table" /></div>
      </section>

      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="Admission planning for the Kyrgyzstan route" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Eligibility" title="Minimum criteria Indian students should meet cleanly" />
        <div className="mt-10"><DataTable rows={eligibility} caption="Kyrgyzstan MBBS eligibility table" /></div>
          ...
          {eligibilityNotes.map((note) => (
            <div key={note} className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm leading-7 text-slate-700">
              {note.includes("/mbbs-without-neet") ? (
                <>
                  If you are reviewing no-India-return paths separately, read <Link href="/mbbs-without-neet" className="font-semibold text-sky-700 underline underline-offset-4">MBBS without NEET for Indian students</Link>.
                </>
              ) : (
                note
              )}
      ...
      <section id="universities" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Top Universities" title="Kyrgyzstan universities students most often compare" />
          <div className="mt-10"><DataTable rows={universities} caption="Kyrgyzstan top universities table" /></div>
        </div>
      </section>

      <section id="fees" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Fees Breakdown" title="Transparent budgeting before you commit to Kyrgyzstan" />
        <div className="mt-10"><DataTable rows={feeBreakdown} caption="Kyrgyzstan fee breakdown table" /></div>
        <h3 className="mt-10 text-xl font-bold text-slate-900">Common additional costs students should budget for</h3>
        <div className="mt-5"><DataTable rows={additionalCosts} caption="Kyrgyzstan additional cost table" /></div>
      </section>

      <section id="exam-context" className="bg-[linear-gradient(180deg,#f8fafc_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="FMGE / NExT Context" title="India licensing context for Kyrgyzstan graduates" />
          <div className="mt-10 grid gap-8 xl:grid-cols-2">
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">Recent Kyrgyzstan comparison context</h3>
              <DataTable rows={examContext} caption="Kyrgyzstan exam context table" />
            </div>
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">What those numbers mean in practice</h3>
              <DataTable rows={kyrgyzExamNotes} caption="Kyrgyzstan exam notes table" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={recognition} caption="Kyrgyzstan recognition table" /></div>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Curriculum" title="Year-wise curriculum shape in Kyrgyzstan MBBS" theme="dark" />
          <div className="mt-10"><DataTable rows={syllabus} caption="Kyrgyzstan MBBS syllabus table" /></div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Living Costs" title="Monthly living picture in Kyrgyzstan" />
          <div className="mt-10"><DataTable rows={livingCosts} caption="Kyrgyzstan living cost table" /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Pros And Cons" title="Balanced view before you choose Kyrgyzstan" />
      ...
      <section className="bg-[linear-gradient(180deg,#ffffff_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Alternatives" title="How Kyrgyzstan compares with other common destinations" />
          <div className="mt-10"><DataTable rows={comparison} caption="Kyrgyzstan alternatives comparison table" /></div>
          <p className="mt-6 text-sm leading-7 text-slate-600">
            For a more India-like academic and cultural route, compare with <Link href="/mbbs-admission-in-bangladesh-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS Admission in Bangladesh 2026-27 Guide</Link>. For a broader Russian route comparison, review <Link href="/mbbs-in-russia" className="font-semibold text-sky-700 underline underline-offset-4">MBBS Admission in Russia 2026-27 Complete Guide</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={scholarships} caption="Kyrgyzstan scholarships table" /></div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={careerPathways} caption="Kyrgyzstan career pathways table" /></div>
      ...
      <KyrgyzstanLeadSection />

      <section id="faq" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-5xl px-4 lg:px-8">
          <SectionHeading eyebrow="FAQ" title="Common Kyrgyzstan MBBS questions Indian students ask" theme="dark" />
