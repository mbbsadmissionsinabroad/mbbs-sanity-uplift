...
function GeorgiaLeadForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        <label htmlFor="georgia-name" className="mb-1 block text-sm font-medium text-slate-700">
          Full name
        </label>
        <input
          id="georgia-name"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label htmlFor="georgia-phone" className="mb-1 block text-sm font-medium text-slate-700">
            WhatsApp number
          </label>
          <input
            id="georgia-phone"
        ...
        <div>
          <label htmlFor="georgia-email" className="mb-1 block text-sm font-medium text-slate-700">
            Email
          </label>
          <input
            id="georgia-email"
      ...
      <div>
        <label htmlFor="georgia-university" className="mb-1 block text-sm font-medium text-slate-700">
...
export default function GeorgiaLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      fields: {
        ...
        Course: "MBBS Abroad",
        StudyCountry: "Georgia",
        College: activeForm.preferredUniversity,
      },
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: MBBS in Georgia Page",
        },
      ],
    };
    ...
    try {
      ...
      router.push("/thank-you?title=MBBS%20in%20Georgia");
    } catch (error) {
      console.error(error);
  ...
  return (
    <>
      ...
      {showPopup ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">Get personalised Georgia admission guidance</h3>
            <p className="mt-3 text-base leading-7 text-slate-600">Share your details and our team can help with Georgia university shortlisting, FMGE-focused filtering, fee planning and whether this route fits your India-return goals.</p>
      ...
      <section id="georgia-contact-form" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">Fill this once and the team can contact you with Georgia options that fit your score, budget and India-return plans.</p>
            <div className="mt-8">
              <GeorgiaLeadForm
                formData={formData}
