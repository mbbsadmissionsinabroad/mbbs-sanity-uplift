...
import GeorgiaLeadSection from "./GeorgiaLeadSection";
import {
  additionalCosts,
  advantages,
  articleSchema,
    ...
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-sky-100">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
          <div>
            <div className="inline-flex rounded-full border border-sky-200 bg-white/90 px-4 py-2 text-sm font-medium text-sky-800 shadow-sm">2026-27 Georgia admissions guide for Indian medical aspirants</div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700 md:text-xl">Compare FMGE outcomes, total cost, visa-free access, university quality and India-return value before committing to the Georgia route.</p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#georgia-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading level="h2" eyebrow="Quick Summary" title="A fast Georgia snapshot before you go deeper" />
        ...
        <div className="mt-8 rounded-[28px] border border-sky-200 bg-sky-50 p-5 text-sm leading-7 text-sky-950">Georgia is strongest when you choose it as a data-led India-return route, not just because it looks easy to enter.</div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading eyebrow="Key Facts" title="At-a-glance Georgia medicine facts for 2026-27" />
        <div className="mt-10"><DataTable rows={keyFacts} caption="Georgia medicine key facts table" /></div>
      </section>

      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="Admission planning for the Georgia route" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={eligibility} caption="Georgia medicine eligibility table" /></div>
      ...
      <section id="universities" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Top Universities" title="Georgia options students most often compare" />
          <div className="mt-10"><DataTable rows={universities} caption="Georgia top universities table" /></div>
        </div>
      </section>

      <section id="fees" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Fees Breakdown" title="Transparent budgeting before you commit to Georgia" />
        <div className="mt-10"><DataTable rows={feeBreakdown} caption="Georgia fee breakdown table" /></div>
        <h3 className="mt-10 text-xl font-bold text-slate-900">Common additional costs students should budget for</h3>
        <div className="mt-5"><DataTable rows={additionalCosts} caption="Georgia additional cost table" /></div>
      </section>

      <section id="exam-context" className="bg-[linear-gradient(180deg,#f8fafc_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="FMGE / NExT Context" title="India licensing context for Georgia graduates" />
          <div className="mt-10 grid gap-8 xl:grid-cols-2">
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">Recent Georgia comparison context</h3>
              <DataTable rows={examContext} caption="Georgia exam context table" />
            </div>
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">What those numbers mean in practice</h3>
              <DataTable rows={georgiaExamNotes} caption="Georgia exam notes table" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={recognition} caption="Georgia recognition table" /></div>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Curriculum" title="Year-wise curriculum shape in Georgia medicine" theme="dark" />
          <div className="mt-10"><DataTable rows={syllabus} caption="Georgia medicine syllabus table" /></div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Living Costs" title="Monthly living picture in Georgia" />
          <div className="mt-10"><DataTable rows={livingCosts} caption="Georgia living cost table" /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Pros And Cons" title="Balanced view before you choose Georgia" />
      ...
      <section className="bg-[linear-gradient(180deg,#ffffff_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Alternatives" title="How Georgia compares with other common destinations" />
          <div className="mt-10"><DataTable rows={comparison} caption="Georgia alternatives comparison table" /></div>
          <p className="mt-6 text-sm leading-7 text-slate-600">
            Compare Georgia with <Link href="/mbbs-in-belarus-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Belarus 2026-27</Link>, <Link href="/mbbs-in-philippines" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Philippines 2026-27</Link>, <Link href="/mbbs-admission-in-poland-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Poland 2026-27 for Indian students</Link>, <Link href="/mbbs-without-neet" className="font-semibold text-sky-700 underline underline-offset-4">MBBS without NEET for Indian students</Link> and <Link href="/bsc-nursing" className="font-semibold text-sky-700 underline underline-offset-4">BSc Nursing abroad for Indian students</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={scholarships} caption="Georgia scholarships table" /></div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={careerPathways} caption="Georgia career pathways table" /></div>
      </section>
      ...
      <section id="faq" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-5xl px-4 lg:px-8">
          <SectionHeading eyebrow="FAQ" title="Common Georgia medicine questions Indian students ask" theme="dark" />
