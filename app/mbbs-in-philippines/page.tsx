...
import PhilippinesLeadSection from "./PhilippinesLeadSection";
import {
  additionalCosts,
  advantages,
  articleSchema,
    ...
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-sky-100">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
          <div>
            <div className="inline-flex rounded-full border border-sky-200 bg-white/90 px-4 py-2 text-sm font-medium text-sky-800 shadow-sm">2026-27 Philippines admissions guide for Indian medical aspirants</div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700 md:text-xl">Compare BS plus NMAT structure, total cost, FMGE context, English-medium comfort and India-return practicality before committing to the Philippines route.</p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#philippines-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Quick Summary" title="A fast Philippines snapshot before you go deeper" />
        ...
        <div className="mt-8 rounded-[28px] border border-sky-200 bg-sky-50 p-5 text-sm leading-7 text-sky-950">The Philippines is one of the best low-cost English-medium MBBS routes, but students need to understand the BS stage plus NMAT progression clearly before enrolling.</div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading eyebrow="Key Facts" title="At-a-glance Philippines medicine facts for 2026-27" />
        <div className="mt-10"><DataTable rows={keyFacts} caption="Philippines medicine key facts table" /></div>
      </section>

      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="Admission planning for the Philippines route" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={eligibility} caption="Philippines medicine eligibility table" /></div>
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {eligibilityNotes.map((note) => (
            <div key={note} className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm leading-7 text-slate-700">
                {note.includes("/mbbs-admission-in-poland-for-indian-students") ? (
                <>
                    If you want an EU-recognised route instead, compare the Philippines with <Link href="/mbbs-admission-in-poland-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Poland 2026-27 for Indian students</Link> and <Link href="/mbbs-admission-in-lithuania" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Lithuania 2026-27</Link> before deciding.
                </>
              ) : (
                note
              )}
      ...
      <section id="universities" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Top Universities" title="Philippines options students most often compare" />
          <div className="mt-10"><DataTable rows={universities} caption="Philippines top universities table" /></div>
        </div>
      </section>

      <section id="fees" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Fees Breakdown" title="Transparent budgeting before you commit to the Philippines" />
        <div className="mt-10"><DataTable rows={feeBreakdown} caption="Philippines fee breakdown table" /></div>
        <h3 className="mt-10 text-xl font-bold text-slate-900">Common additional costs students should budget for</h3>
        <div className="mt-5"><DataTable rows={additionalCosts} caption="Philippines additional cost table" /></div>
      </section>

      <section id="exam-context" className="bg-[linear-gradient(180deg,#f8fafc_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="FMGE / NExT Context" title="India licensing context for Philippines graduates" />
          <div className="mt-10 grid gap-8 xl:grid-cols-2">
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">Recent Philippines comparison context</h3>
              <DataTable rows={examContext} caption="Philippines exam context table" />
            </div>
            <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={recognition} caption="Philippines recognition table" /></div>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Curriculum" title="Year-wise curriculum shape in the Philippines route" theme="dark" />
          <div className="mt-10"><DataTable rows={syllabus} caption="Philippines medicine syllabus table" /></div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Living Costs" title="Monthly living picture in the Philippines" />
          <div className="mt-10"><DataTable rows={livingCosts} caption="Philippines living cost table" /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Pros And Cons" title="Balanced view before you choose the Philippines" />
      ...
      <section className="bg-[linear-gradient(180deg,#ffffff_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Alternatives" title="How the Philippines compares with other common destinations" />
          <div className="mt-10"><DataTable rows={comparison} caption="Philippines alternatives comparison table" /></div>
          <p className="mt-6 text-sm leading-7 text-slate-600">
            Compare the Philippines with <Link href="/mbbs-admission-in-nepal-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Nepal 2026-27 for Indian students</Link>, the current <Link href="/contact?interest=mbbs-admission-in-vietnam" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Vietnam 2026-27</Link> guidance path, <Link href="/mbbs-admission-in-poland-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Poland 2026-27 for Indian students</Link> and <Link href="/mbbs-admission-in-lithuania" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Lithuania 2026-27</Link>. For India licensing planning, review <Link href="/contact?interest=nmc-next-exam-guide" className="font-semibold text-sky-700 underline underline-offset-4">NMC NEXT exam preparation guide</Link>, <Link href="/mbbs-without-neet" className="font-semibold text-sky-700 underline underline-offset-4">MBBS without NEET for Indian students</Link>, <Link href="/contact?interest=bsc-nursing-abroad" className="font-semibold text-sky-700 underline underline-offset-4">BSc Nursing abroad for Indian students</Link> and <Link href="/contact?interest=cheapest-mbbs-abroad" className="font-semibold text-sky-700 underline underline-offset-4">cheapest MBBS abroad for Indian students 2026</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={scholarships} caption="Philippines scholarships table" /></div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={careerPathways} caption="Philippines career pathways table" /></div>
      </section>
      <StaticPageResourceLinks currentRoute={pageUrl} />


      <PhilippinesLeadSection />

      <section id="faq" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-5xl px-4 lg:px-8">
          <SectionHeading eyebrow="FAQ" title="Common Philippines medicine questions Indian students ask" theme="dark" />
