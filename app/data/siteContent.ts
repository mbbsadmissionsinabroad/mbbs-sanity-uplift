...
export const footerLinkColumns: SiteLink[][] = [
  [
    { title: "MBBS in Europe", href: "/mbbs-admission-in-europe-from-mci-approved-university" },
    { title: "MBBS in Russia", href: "/mbbs-in-russia" },
    { title: "MBBS in Philippines", href: "/mbbs-in-philippines" },
    ...
    { title: "MBBS Without NEET", href: "/mbbs-without-neet" },
  ],
  [
    { title: "MBBS in France", href: "/mbbs-in-france" },
    { title: "MBBS in Finland", href: "/mbbs-admission-in-finland-from-mci-approved-universities" },
    { title: "MBBS in Netherlands", href: "/mbbs-admission-in-netherlands-for-indian-students" },
    ...
    { title: "MBBS in Romania", href: "/mbbs-admission-in-romania-for-indian-students" },
    { title: "MBBS in Lithuania", href: "/mbbs-admission-in-lithuania" },
  ],
  [
    { title: "MBBS in Bangladesh", href: "/mbbs-admission-in-bangladesh-for-indian-students" },
    { title: "MBBS in Nepal", href: "/mbbs-admission-in-nepal-for-indian-students" },
    { title: "MBBS in India", href: "/mbbs-in-india" },
    { title: "MBBS in Armenia", href: "/mbbs-in-armenia" },
    { title: "MBBS in Azerbaijan", href: "/mbbs-in-azerbaijan" },
    { title: "MBBS in Belarus", href: "/mbbs-in-belarus-for-indian-students" },
    { title: "MBBS in Malaysia", href: "/mbbs-admission-in-malaysia-for-indian-students" },
    { title: "MBBS in Vietnam", href: "/mbbs-in-vietnam" },
  ],
  [
    { title: "Nursing Jobs Abroad", href: "/nursing-jobs-in-abroad" },
    { title: "Nursing Jobs in Germany", href: "/nursing-job-in-germany" },
    { title: "Nursing Jobs in Canada", href: "/nursing-jobs-in-canada" },
    { title: "Nursing Jobs in Denmark", href: "/nursing-jobs-in-denmark" },
    { title: "Nursing Jobs in Netherlands", href: "/nursing-jobs-in-netherlands" },
    { title: "Nursing Jobs in Lithuania", href: "/nursing-jobs-in-lithuania" },
    { title: "Study Nursing in Bosnia", href: "/study-nursing-in-bosnia" },
    { title: "PG Abroad", href: "/pg-in-abroad" },
    { title: "Medical PG in Germany", href: "/medical-pg-in-germany" },
    { title: "Medical PG in Europe", href: "/medical-pg-in-europe-for-indian-students" },
    { title: "UKMLA Guide", href: "/united-kingdom-medical-licensing-assessment-ukmla" },
    { title: "PG in Pharm D", href: "/pg-in-pharm-d" },
    { title: "Ausbildung", href: "/ausbildung" },
    { title: "Learn German", href: "/learn-german-language-course-in-bangalore" },
  ],
