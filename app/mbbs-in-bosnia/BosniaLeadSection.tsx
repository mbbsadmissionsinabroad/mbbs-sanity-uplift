...
function BosniaLeadForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        <label htmlFor="bosnia-name" className="mb-1 block text-sm font-medium text-slate-700">
          Full name
        </label>
        <input
          id="bosnia-name"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label htmlFor="bosnia-phone" className="mb-1 block text-sm font-medium text-slate-700">
            WhatsApp number
          </label>
          <input
            id="bosnia-phone"
        ...
        <div>
          <label htmlFor="bosnia-email" className="mb-1 block text-sm font-medium text-slate-700">
            Email
          </label>
          <input
            id="bosnia-email"
      ...
      <div>
        <label htmlFor="bosnia-university" className="mb-1 block text-sm font-medium text-slate-700">
          Preferred university
        </label>
        <select
          id="bosnia-university"
...
export default function BosniaLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      ...
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: MBBS in Bosnia Page",
        },
      ],
    };
    ...
    try {
      ...
      router.push("/thank-you?title=MBBS%20in%20Bosnia");
    } catch (error) {
      console.error(error);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">
              Get personalised Bosnia admission guidance
            </h3>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] bg-[linear-gradient(135deg,#052e2b_0%,#0f172a_100%)] p-8 text-white">
            ...
            <p className="mt-4 text-base leading-8 text-slate-300">
              Use this section for shortlist review, budget planning, admission
              documentation and Bosnia intake guidance for 2026-27.
            </p>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              Fill this once and the team can contact you with the Bosnia
              options that fit your budget and long-term goals.
            </p>
            <div className="mt-8">
              <BosniaLeadForm
                formData={formData}
