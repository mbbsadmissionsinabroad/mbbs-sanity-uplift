...
function PharmDLeadForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        <label
          htmlFor="pharmd-university"
          className="mb-1 block text-sm font-medium text-slate-700"
        >
          Preferred university
        </label>
        <select
          id="pharmd-university"
...
export default function PharmDLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      ...
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: PG in Pharm D Page",
        },
      ],
    };
    ...
    try {
      ...
      router.push("/thank-you?title=PG%20in%20Pharm%20D");
    } catch (error) {
      console.error(error);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">
              Get personalised Germany pharmacy guidance
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Share your details and our team will help with Approbation planning,
              university shortlisting, fee comparison, and Germany pharmacist career steps.
            </p>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] bg-[linear-gradient(135deg,#1d4ed8_0%,#0f172a_100%)] p-8 text-white">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-blue-200">
              Contact Germany Pharmacy Desk
            </p>
            <h3 className="mt-4 text-3xl font-bold">
              Speak to our team on WhatsApp or request a callback
            </h3>
            <p className="mt-4 text-base leading-8 text-slate-300">
              Use this section for Germany pharmacy master's guidance, Approbation planning,
              university fit, budget questions, and pharmacist career pathways.
            </p>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <h3 className="mt-4 text-3xl font-bold text-slate-950">
              Request Germany pharmacy support
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Fill this once and the team can contact you with the Germany pharmacy
              route that best fits your profile, budget, and long-term licensing goals.
            </p>
            <div className="mt-8">
              <PharmDLeadForm
                formData={formData}
