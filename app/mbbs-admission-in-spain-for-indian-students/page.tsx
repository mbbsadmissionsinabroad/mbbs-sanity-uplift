...
import SpainLeadSection from "./SpainLeadSection";
import {
  additionalCosts,
  advantages,
  articleSchema,
    ...
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-sky-100">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
          <div>
            <div className="inline-flex rounded-full border border-sky-200 bg-white/90 px-4 py-2 text-sm font-medium text-sky-800 shadow-sm">2026-27 Spain admissions guide for Indian medical aspirants</div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700 md:text-xl">Compare public versus private Spain, Spanish versus English-medium options, total budget, MIR pathway and EU-career value before committing to the Spain route.</p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#spain-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
          ...
          <aside className="self-start rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_30px_80px_rgba(15,23,42,0.08)] lg:sticky lg:top-28">
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                ["#fees", "Fees breakdown"],
                ["#exam-context", "Career and India-return lens"],
                ["#faq", "FAQ section"],
              ].map(([href, label]) => (
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Quick Summary" title="A fast Spain snapshot before you go deeper" />
      ...
      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="Admission planning for the Spain route" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={eligibility} caption="Spain medicine eligibility table" /></div>
          ...
          {eligibilityNotes.map((note) => (
            <div key={note} className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm leading-7 text-slate-700">
              {note.includes("MBBS in Georgia") ? (
                <>
                    If your main goal is an English-medium India-return route, compare Spain with <Link href="/mbbs-in-georgia" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Georgia for Indian students</Link> and <Link href="/mbbs-in-belarus-for-indian-students" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Belarus for Indian students</Link> before deciding.
                </>
              ) : (
                note
              )}
      ...
      <section id="universities" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Top Universities" title="Spain options students most often compare" />
          <div className="mt-10"><DataTable rows={universities} caption="Spain top universities table" /></div>
        </div>
      </section>

      <section id="fees" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Fees Breakdown" title="Transparent budgeting before you commit to Spain" />
        <div className="mt-10"><DataTable rows={feeBreakdown} caption="Spain fee breakdown table" /></div>
        <h3 className="mt-10 text-xl font-bold text-slate-900">Common additional costs students should budget for</h3>
        <div className="mt-5"><DataTable rows={additionalCosts} caption="Spain additional cost table" /></div>
      </section>

      <section id="exam-context" className="bg-[linear-gradient(180deg,#f8fafc_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Career And India-Return Lens" title="How Spain compares for long-term planning" />
          <div className="mt-10 grid gap-8 xl:grid-cols-2">
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">Recent Spain comparison context</h3>
              <DataTable rows={examContext} caption="Spain exam context table" />
            </div>
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">What those comparisons mean in practice</h3>
              <DataTable rows={spainExamNotes} caption="Spain exam notes table" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Recognition" title="Recognition stack and why Spain stands out" />
        <div className="mt-10"><DataTable rows={recognition} caption="Spain recognition table" /></div>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Curriculum" title="Year-wise curriculum shape in Spain medicine" theme="dark" />
          <div className="mt-10"><DataTable rows={syllabus} caption="Spain medicine syllabus table" /></div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Living Costs" title="Monthly living picture in Spain" />
          <div className="mt-10"><DataTable rows={livingCosts} caption="Spain living cost table" /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Pros And Cons" title="Balanced view before you choose Spain" />
      ...
      <section className="bg-[linear-gradient(180deg,#ffffff_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Alternatives" title="How Spain compares with other common destinations" />
          <div className="mt-10"><DataTable rows={comparison} caption="Spain alternatives comparison table" /></div>
          <p className="mt-6 text-sm leading-7 text-slate-600">
            Compare Spain with <Link href="/contact?interest=mbbs-in-germany" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Germany for free</Link>, <Link href="/mbbs-in-georgia" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Georgia for Indian students</Link>, <Link href="/mbbs-in-uzbekistan" className="font-semibold text-sky-700 underline underline-offset-4">MBBS in Uzbekistan 2026</Link>, <Link href="/mbbs-without-neet" className="font-semibold text-sky-700 underline underline-offset-4">MBBS without NEET for Indian students</Link> and <Link href="/contact?interest=bsc-nursing" className="font-semibold text-sky-700 underline underline-offset-4">BSc Nursing abroad</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={scholarships} caption="Spain scholarships table" /></div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        <div className="mt-10"><DataTable rows={careerPathways} caption="Spain career pathways table" /></div>
      </section>
      ...
      <section id="faq" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-5xl px-4 lg:px-8">
          <SectionHeading eyebrow="FAQ" title="Common Spain medicine questions Indian students ask" theme="dark" />
