...
import LithuaniaLeadSection from "./LithuaniaLeadSection";
import {
  additionalCosts,
  advantages,
  articleSchema,
...
function SectionHeading({
  ...
  return (
    <div className="max-w-3xl">
      <p
        className={`text-sm font-semibold uppercase tracking-[0.3em] ${dark ? "text-sky-300" : "text-sky-700"}`}
      >
        {eyebrow}
      </p>
      <HeadingTag
    ...
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
          <div>
            <div className="inline-flex rounded-full border border-sky-200 bg-white/90 px-4 py-2 text-sm font-medium text-sky-800 shadow-sm">
              2026-27 Lithuania admissions guide for Indian medical aspirants
            </div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700 md:text-xl">
              Compare IELTS requirements, entrance-test effort, total cost,
              EU-career value, Schengen mobility and India-return practicality
              before committing to the Lithuania route.
            </p>
      ...
      >
        <SectionHeading
          ...
          title="A fast Lithuania snapshot before you go deeper"
        />
        ...
        <div className="mt-8 rounded-[28px] border border-sky-200 bg-sky-50 p-5 text-sm leading-7 text-sky-950">
          Lithuania is one of the cleanest EU medicine routes for Indian
          students who can handle the added IELTS and entrance-test filtering.
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading
          eyebrow="Key Facts"
          title="At-a-glance Lithuania medicine facts for 2026-27"
        />
        <div className="mt-10">
          <DataTable rows={keyFacts} caption="Lithuania medicine key facts table" />
        </div>
      </section>
      ...
      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            eyebrow="Timeline"
            title="Admission planning for the Lithuania route"
            theme="dark"
          />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading
          eyebrow="Eligibility"
          title="Minimum criteria Indian students should plan around"
        />
        <div className="mt-10">
          <DataTable
            rows={eligibility}
            caption="Lithuania medicine eligibility table"
          />
        </div>
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {eligibilityNotes.map((note) => (
            ...
            >
                ...
                <>
                  If your main goal is the absolute cheapest EU route rather
                  than compact-system quality, compare Lithuania with{" "}
                  <Link
                  ...
                  <Link
                    ...
                    className="font-semibold text-sky-700 underline underline-offset-4"
                  >
                    MBBS in Hungary 2026-27 for Indian students
                  </Link>{" "}
                  before deciding.
                </>
              ) : (
      ...
      <section id="universities" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            ...
            title="Lithuania options students most often compare"
          />
          <div className="mt-10">
            <DataTable
              rows={universities}
              caption="Lithuania top universities table"
            />
          </div>
        </div>
      </section>
      ...
      <section id="fees" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading
          ...
          title="Transparent budgeting before you commit to Lithuania"
        />
        <div className="mt-10">
          <DataTable
            rows={feeBreakdown}
            caption="Lithuania fee breakdown table"
          />
        </div>
        ...
        <div className="mt-5">
          <DataTable
            ...
            caption="Lithuania additional cost table"
          />
        </div>
      </section>
      ...
      <section
        id="exam-context"
        className="bg-[linear-gradient(180deg,#f8fafc_0%,#eff6ff_100%)] py-16"
      >
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            eyebrow="FMGE / NExT Context"
            title="India licensing context for Lithuania graduates"
          />
          <div className="mt-10 grid gap-8 xl:grid-cols-2">
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">
                Recent Lithuania comparison context
              </h3>
              <DataTable
                rows={examContext}
                caption="Lithuania exam context table"
              />
            </div>
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">
              ...
              <DataTable
                rows={lithuaniaExamNotes}
                caption="Lithuania exam notes table"
              />
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading
          eyebrow="Recognition"
          title="Recognition stack and why it matters"
        />
        <div className="mt-10">
          <DataTable rows={recognition} caption="Lithuania recognition table" />
        </div>
      </section>
      ...
      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            eyebrow="Curriculum"
            title="Year-wise curriculum shape in Lithuania medicine"
            theme="dark"
          />
          <div className="mt-10">
            <DataTable rows={syllabus} caption="Lithuania medicine syllabus table" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            ...
            title="Monthly living picture in Lithuania"
          />
          <div className="mt-10">
            <DataTable rows={livingCosts} caption="Lithuania living cost table" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading
          ...
          title="Balanced view before you choose Lithuania"
        />
      ...
      <section className="bg-[linear-gradient(180deg,#ffffff_0%,#eff6ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            ...
            title="How Lithuania compares with other common destinations"
          />
          <div className="mt-10">
            <DataTable
              rows={comparison}
              caption="Lithuania alternatives comparison table"
            />
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading
          ...
          title="Funding and affordability options"
        />
        <div className="mt-10">
          <DataTable
            rows={scholarships}
            caption="Lithuania scholarships table"
          />
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading
            eyebrow="Documents"
            title="The application file you should prepare early"
          />
          <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {documents.map((item) => (
              <div
                key={item}
                className="rounded-[28px] border border-slate-200 bg-white p-5 text-base leading-7 text-slate-700 shadow-[0_18px_40px_rgba(15,23,42,0.05)]"
              >
                {item}
              </div>
            ))}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading
          ...
          title="Where this degree can take you next"
        />
        <div className="mt-10">
          <DataTable
            rows={careerPathways}
            caption="Lithuania career pathways table"
          />
        </div>
        <p className="mt-6 text-sm leading-7 text-slate-600">
      ...
      <LithuaniaLeadSection />

      <section id="faq" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-5xl px-4 lg:px-8">
          <SectionHeading
            eyebrow="FAQ"
            title="Common Lithuania medicine questions Indian students ask"
            theme="dark"
          />
