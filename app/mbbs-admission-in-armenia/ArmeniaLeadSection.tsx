...
function ArmeniaLeadForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        <label htmlFor="armenia-name" className="mb-1 block text-sm font-medium text-slate-700">
          Full name
        </label>
        <input
          id="armenia-name"
          ...
          onChange={onChange}
          required
          className="w-full rounded-2xl border border-slate-300 px-4 py-3 text-slate-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
          placeholder="Enter your full name"
        />
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <label htmlFor="armenia-phone" className="mb-1 block text-sm font-medium text-slate-700">
            WhatsApp number
          </label>
          <input
            id="armenia-phone"
        ...
        <div>
          <label htmlFor="armenia-email" className="mb-1 block text-sm font-medium text-slate-700">
            Email
          </label>
          <input
            id="armenia-email"
      ...
      <div>
        <label htmlFor="armenia-university" className="mb-1 block text-sm font-medium text-slate-700">
          Preferred university
        </label>
        <select
          id="armenia-university"
...
export default function ArmeniaLeadSection() {
  ...
  const submitLead = async (
    ...
    const requestData = {
      fields: {
        ...
        Course: "MBBS Abroad",
        StudyCountry: "Armenia",
        College: activeForm.preferredUniversity,
      },
      actions: [
        {
          type: "SYSTEM_NOTE",
          text: "Lead Source: MBBS Admission in Armenia Page",
        },
      ],
    };
    ...
    try {
      ...
      router.push("/thank-you?title=MBBS%20Admission%20in%20Armenia");
    } catch (error) {
      console.error(error);
  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[32px] bg-white p-6 shadow-2xl md:p-8">
            ...
            <h3 className="mt-3 text-3xl font-bold text-slate-950">
              Get personalised Armenia admission guidance
            </h3>
            <p className="mt-3 text-base leading-7 text-slate-600">
              Share your details and our team will help with eligibility,
              university shortlisting, fee planning and the next application
              steps.
            </p>
      ...
      <section
        id="armenia-contact-form"
        className="mx-auto max-w-7xl px-4 py-16 lg:px-8"
      >
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] bg-[linear-gradient(135deg,#052e2b_0%,#0f172a_100%)] p-8 text-white">
            ...
            <p className="mt-4 text-base leading-8 text-slate-300">
              ...
              contact with the counselling team.
            </p>
            ...
            <div className="mt-8 rounded-[28px] border border-white/10 bg-white/5 p-5 text-sm leading-7 text-slate-300">
              Best for: counselling, shortlist review, document readiness,
              budget planning and Armenia intake guidance for 2026-27.
            </div>
          </div>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              Fill this once and the team can contact you with the right Armenia
              options instead of generic advice.
            </p>
            <div className="mt-8">
              <ArmeniaLeadForm
                formData={formData}
