...
import GermanyLeadSection from "./GermanyLeadSection";
import {
  advantages,
  articleSchema,
  careerPathways,
  ...
  return (
    <main className="bg-[linear-gradient(180deg,#f4f8ff_0%,#fffaf2_28%,#ffffff_65%)] text-slate-900">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
          <div>
            <div className="inline-flex rounded-full border border-blue-200 bg-white/90 px-4 py-2 text-sm font-medium text-blue-800 shadow-sm">
              2026-27 Germany admissions guide for Indian medical aspirants
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#germany-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading level="h2" eyebrow="Quick Summary" title="A fast Germany snapshot before you go deeper" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading eyebrow="Key Facts" title="At-a-glance Germany medical study facts for 2026-27" />
        <div className="mt-10"><DataTable rows={keyFacts} /></div>
      </section>

      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="Admission calendar for the 2026-27 Germany intake" theme="dark" />
      ...
      <section id="universities" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Universities" title="Top Germany medical universities for Indian students" />
          <div className="mt-10"><DataTable rows={universities} /></div>
        </div>
      </section>

      <section id="fees" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Fees Breakdown" title="Transparent Germany cost picture over the full 6-year route" />
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href="#germany-contact-form" className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Get a Custom Fee Plan</a>
          <a href={`tel:${ivrNumber.replace(/\s+/g, "")}`} className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Call IVR</a>
        </div>
      </section>

      <section id="fmge" className="bg-[linear-gradient(180deg,#f8fafc_0%,#edf5ff_100%)] py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="FMGE and NEXT" title="Germany exam context and what it means for Indian students" />
          <div className="mt-10 grid gap-8 xl:grid-cols-[0.9fr_1.1fr]">
            <div>
              <h3 className="mb-4 text-xl font-bold text-slate-900">Germany-specific FMGE context</h3>
            ...
            <div className="rounded-[30px] border border-slate-200 bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.05)]">
              <h3 className="text-xl font-bold text-slate-900">What these numbers actually suggest</h3>
              <div className="mt-5 space-y-4 text-base leading-8 text-slate-700">
                <p>Germany's FMGE or NEXT-facing sample is much smaller than Russia or Kyrgyzstan, so the pass-rate story is less about volume and more about pathway choice.</p>
                <p>Many Germany-trained students aim for Germany, the EU or the UK rather than returning directly to India, which means FMGE percentages do not tell the entire career story.</p>
                <p>If India is your goal, you should still treat NEXT preparation as a parallel track from the first half of the course onward.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Recognition" title="How Germany degree recognition affects your career options" />
        <div className="mt-10"><DataTable rows={recognition} /></div>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Curriculum" title="Year-wise Staatsexamen structure in Germany" />
          <div className="mt-10"><DataTable rows={syllabus} /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="After Graduation" title="Licensing steps to practise after medical study in Germany" />
      ...
      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Student Life" title="What living in Germany usually costs each month" theme="dark" />
          <div className="mt-10"><DataTable rows={livingCosts} /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Pros and Cons" title="A realistic view of Germany as an MBBS-equivalent destination" />
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Comparison" title="How Germany compares with other MBBS abroad options" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Career Pathways" title="What you can do after a Germany medical degree" />
      ...
      <section className="bg-slate-50 py-12">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 lg:px-8">
          <div>
            ...
            <p className="mt-2 text-lg font-semibold text-slate-900">Talk to the Germany team before you shortlist a university.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <a href="#germany-contact-form" className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Open Contact Form</a>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <p className="mt-8 max-w-4xl text-base leading-8 text-slate-700 md:text-lg">
            ...
            <Link href="/mbbs-without-neet" className="font-semibold text-blue-700 hover:text-blue-900">MBBS without NEET for Indian students</Link>. Germany offers unmatched prestige and mobility, but India-side licensing still starts with the correct eligibility path.
          </p>
        </div>
      </section>

      <section id="faq" className="mx-auto max-w-5xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="FAQ" title="15 common Germany questions students and parents ask" />
