      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <p className="mt-8 max-w-4xl text-base leading-8 text-slate-700 md:text-lg">
            ...
            <Link href="/contact" className="font-semibold text-blue-700 hover:text-blue-900">MBBS without NEET for Indian students</Link>. Germany offers unmatched prestige and mobility, but India-side licensing still starts with the correct eligibility path.
          </p>
        </div>
      </section>
