...
import CanadaNursingLeadSection from "./CanadaNursingLeadSection";
import {
  advantages,
  articleSchema,
  arrivalSteps,
...
export default function NursingJobsInCanadaPage() {
  return (
    <main className="bg-[linear-gradient(180deg,#eff6ff_0%,#f8fafc_28%,#ffffff_65%)] text-slate-900">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-16">
          <div>
            <div className="inline-flex rounded-full border border-blue-200 bg-white/90 px-4 py-2 text-sm font-medium text-blue-800 shadow-sm">
              2026-27 Canada nursing jobs guide for Indian nurses
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#canada-nursing-contact-form" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Request Callback</a>
      ...
      <section id="quick-summary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading level="h2" eyebrow="Quick Summary" title="A fast Canada nursing snapshot before you go deeper" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <SectionHeading eyebrow="Key Facts" title="At-a-glance Canada nursing facts for 2026-27" />
        <div className="mt-10"><DataTable rows={keyFacts} caption="Canada nursing key facts table" /></div>
      </section>

      <section id="timeline" className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Timeline" title="Month-by-month Canada nursing roadmap" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Step By Step" title="The practical process Indian nurses should actually follow" />
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Eligibility" title="Who fits the RN route best and where GNM holders should be careful" />
          <div className="mt-10"><DataTable rows={eligibility} caption="Canada nursing eligibility table" /></div>
      ...
      <section id="provinces" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Top Provinces" title="Where Indian nurses most often shortlist Canada in 2026" />
        <div className="mt-10"><DataTable rows={provinces} caption="Canada top nursing provinces table" /></div>
      </section>

      <section id="costs" className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Costs and Fees" title="What the Canada nursing path really costs before you start earning" />
          <div className="mt-10"><DataTable rows={costBreakdown} caption="Canada nursing fees and costs table" /></div>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="#canada-nursing-contact-form" className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Get a Personal Plan</a>
            <a href={`tel:${ivrNumber.replace(/\s+/g, "")}`} className="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:text-slate-950">Call IVR</a>
          </div>
        </div>
      </section>
      ...
      <section id="salary" className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Salary Data" title="What the money actually looks like by province and role" />
        <div className="mt-10 grid gap-8 xl:grid-cols-2">
          <div>
            <h3 className="mb-4 text-xl font-bold text-slate-900">Province-wise RN salary view</h3>
            <DataTable rows={salaryByProvince} caption="Canada province-wise RN salary table" />
          </div>
          <div>
            <h3 className="mb-4 text-xl font-bold text-slate-900">Role-wise nursing salary view</h3>
            <DataTable rows={roleSalaries} caption="Canada role-wise nursing salary table" />
          </div>
        </div>
      ...
      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Recognition" title="Which bodies actually matter in the Canada nursing route" theme="dark" />
          <div className="mt-10"><DataTable rows={recognition} caption="Canada nursing recognition table" /></div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Career Progression" title="What a realistic Canada nursing earnings path looks like over time" />
        <div className="mt-10"><DataTable rows={careerProgression} caption="Canada nursing career progression table" /></div>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="After Landing" title="What happens after you arrive in Canada" />
          <div className="mt-10 grid gap-4 md:grid-cols-2">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Cost of Living" title="What you might actually spend every month in Canada" />
        <div className="mt-10"><DataTable rows={livingCosts} caption="Canada nursing living cost table" /></div>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Pros and Cons" title="A realistic view of Canada for Indian nurses" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Comparison" title="How Canada compares with other nursing destinations" />
        <div className="mt-10"><DataTable rows={comparison} caption="Canada nursing comparison table" /></div>
        <p className="mt-6 text-base leading-7 text-slate-700">
            If you want a broader healthcare migration comparison, explore <Link href="/bsc-nursing" className="font-semibold text-blue-700 hover:text-blue-900">BSc Nursing abroad</Link>. If you are comparing Europe-oriented long-term routes, you can also read <Link href="/mbbs-admission-in-germany-for-indian-students" className="font-semibold text-blue-700 hover:text-blue-900">MBBS in Germany for free</Link>, <Link href="/mbbs-without-neet" className="font-semibold text-blue-700 hover:text-blue-900">MBBS without NEET for Indian students</Link> and <Link href="/mbbs-in-uzbekistan" className="font-semibold text-blue-700 hover:text-blue-900">MBBS in Uzbekistan 2026</Link> for broader study-abroad context.
        </p>
      </section>

      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Support and Funding" title="Where nurses can find practical support or cost relief" />
          <div className="mt-10"><DataTable rows={scholarships} caption="Canada nursing support options table" /></div>
        </div>
      </section>

      <section className="bg-slate-950 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <SectionHeading eyebrow="Documents" title="What you should prepare before you start the process" theme="dark" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="Career Pathways" title="What this route can open up after your Canadian registration" />
        <div className="mt-10"><DataTable rows={careerPathways} caption="Canada nursing career pathways table" /></div>
      </section>
      ...
      <section className="bg-slate-50 py-12">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 lg:px-8">
          <div>
            ...
            <p className="mt-2 text-lg font-semibold text-slate-900">Talk to the Canada nursing team before you choose your province and pathway.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <a href="#canada-nursing-contact-form" className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Open Contact Form</a>
      ...
      <CanadaNursingLeadSection />

      <section id="faq" className="mx-auto max-w-5xl px-4 py-16 lg:px-8">
        <SectionHeading eyebrow="FAQ" title="15 common Canada nursing questions Indian nurses ask" />
